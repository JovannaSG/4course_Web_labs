# Лабораторные работы по предмету "Сетевые и интернет технолгии" 4 курс
...
С помощью flake8 просканировал файлы проекта. В файлах были незначительные ошибки в оформлении кода. Наприер в файле `authorization.py` анализатор показал следующие ошибки.<br>
Список ошибок **ДО** исправления

![](./5lab/docs/auth_ДО.png)

Список ошибок **ПОСЛЕ** исправления

![](./5lab/docs/auth_ПОСЛЕ.png)

Оставшиеся ошибки не сильно влияют на чтение кода.

## Результаты анализа pylint
С помощью pylint просканировал файлы. Во всех файлах, кроме `authorization.py` были ошибки в оформлении кода. В файле `authorization.py` pylint подсказал, что был использован лишний **else** и что можно было инвертировать условие дабы не писать код после строчки с **return**.<br>
Список ошибок **ДО**

![](./5lab/docs/pylint_auth_ДО.png)

Список ошибок **ПОСЛЕ**

![](./5lab/docs/pylint_auth_ПОСЛЕ.png)
